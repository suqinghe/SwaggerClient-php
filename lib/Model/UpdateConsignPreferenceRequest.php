<?php
/**
 * UpdateConsignPreferenceRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * UpdateConsignPreferenceRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateConsignPreferenceRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateConsignPreferenceRequest';
    ...
    protected static $swaggerTypes = [
        'data' => '\Swagger\Client\Model\UpdateConsignPreferenceRequestData',
        'ebay_id' => 'string',
        'message_id' => 'string',
        'method_name' => 'string',
        'timestamp' => 'int'
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\UpdateConsignPreferenceRequestData
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\UpdateConsignPreferenceRequestData $data data
     *
     * @return $this
     */
