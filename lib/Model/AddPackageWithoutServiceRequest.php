<?php
/**
 * AddPackageWithoutServiceRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * AddPackageWithoutServiceRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddPackageWithoutServiceRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddPackageWithoutServiceRequest';
    ...
    protected static $swaggerTypes = [
        'data' => '\Swagger\Client\Model\PackageInfoWithoutServiceRequest',
        'ebay_id' => 'string',
        'message_id' => 'string',
        'method_name' => 'string',
        'timestamp' => 'int'
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\PackageInfoWithoutServiceRequest
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\PackageInfoWithoutServiceRequest $data data
     *
     * @return $this
     */
