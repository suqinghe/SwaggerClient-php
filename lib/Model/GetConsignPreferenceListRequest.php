<?php
/**
 * GetConsignPreferenceListRequest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * GetConsignPreferenceListRequest Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GetConsignPreferenceListRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GetConsignPreferenceListRequest';
    ...
    protected static $swaggerTypes = [
        'data' => '\Swagger\Client\Model\GetConsignPreferenceListRequestData',
        'ebay_id' => 'string',
        'message_id' => 'string',
        'method_name' => 'string',
        'timestamp' => 'int'
     ...
     * Gets data
     *
     * @return \Swagger\Client\Model\GetConsignPreferenceListRequestData
     */
     ...
     * Sets data
     *
     * @param \Swagger\Client\Model\GetConsignPreferenceListRequestData $data data
     *
     * @return $this
     */
