<?php
/**
 * UpdateAddressPreferenceRequestData
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * UpdateAddressPreferenceRequestData Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateAddressPreferenceRequestData implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateAddressPreferenceRequestData';
     ...
     * Sets city
     *
     * @param string $city 市 <a target='_blank' href='/open/development-guide-detail?id=36'>请参考地址编码说明</a>
     *
     * @return $this
     */
     ...
     * Sets country_code
     *
     * @param string $country_code 国家或地区 <a target='_blank' href='/open/development-guide-detail?id=36'>请参考地址编码说明</a>
     *
     * @return $this
     */
     ...
     * Sets district
     *
     * @param string $district 区县，非香港台湾地区必填 <a target='_blank' href='/open/development-guide-detail?id=36'>请参考地址编码说明</a>
     *
     * @return $this
     */
     ...
     * Sets postcode
     *
     * @param string $postcode 邮政编码，非香港地区必填
     *
     * @return $this
     */
     ...
     * Sets province
     *
     * @param string $province 省 <a target='_blank' href='/open/development-guide-detail?id=36'>请参考地址编码说明</a>
     *
     * @return $this
     */
